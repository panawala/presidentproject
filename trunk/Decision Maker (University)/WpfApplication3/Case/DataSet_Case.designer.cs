...
SELECT Id, CaseTitle, CaseCity, CaseProvince, CaseCountry, CaseTopic, CaseCompany, CaseManager, CreateTime, UpdateTime, CasePDF, Menu1, Menu2, Menu3, StarLevel FROM T_Case WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = @"SELECT        CaseCity, CaseCompany, CaseCountry, CaseManager, CasePDF, CaseProvince, CaseTitle, CaseTopic, CreateTime, Id, Menu1, Menu2, Menu3, StarLevel, 
                         UpdateTime
FROM            T_Case
