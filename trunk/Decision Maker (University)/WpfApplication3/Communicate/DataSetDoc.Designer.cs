...
SELECT Id, DocTitle, DocAddress, SubmissionDate, IsRead, DocType FROM T_Doc WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[4].CommandText = "SELECT Id, DocTitle, DocAddress, SubmissionDate, IsRead, DocType FROM dbo.T_Presi" +
                "dentDoc where Id=@Id";
            ...
            this._commandCollection[6].CommandText = "UPDATE [dbo].[T_PresidentDoc] SET  [IsRead] = @IsRead WHERE (Id = @Id)";
