...
namespace WpfApplication3
{
    class WeiboHelper
    {
        ...
        string body ="<body style=\"margin-left:-20px;margin-top:-20px;background-color=#353535;\" scroll=\"no\" >";
		string frame1 ="<iframe frameborder=\"0\" scrolling=\"no\" style=\"width:278px;height:310px;background-color=#353535;\" src=\"http://widget.weibo.com/livestream/listlive.php?language=zh_cn&width=278&height=310&uid=2389517080&skin=10&refer=1&appkey=&pic=0&titlebar=1&border=1&publish=0&atalk=1&recomm=0&at=0&atopic=";
